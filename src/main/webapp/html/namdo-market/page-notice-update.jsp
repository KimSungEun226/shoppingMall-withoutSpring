            ...
            <div id="nav-5-3-primary-ver" class="tab-content g-pt-20 g-pt-0--md">
                ...
                <div id="accordion-12-1" class="u-accordion u-accordion-color-primary" role="tablist" aria-multiselectable="true">
                    ...
                    <table class="text-left w-100">
                      <thead class="h6 g-brd-bottom g-brd-gray-light-v3 g-color-black text-uppercase">
                        ...
                        <th>
		                  ...
		                  <div class="input-group mb-1">
		                    <b class="h5 g-color-black">제목:&nbsp;&nbsp;&nbsp;</b><input name="board_name" class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v3 g-rounded-left-3 g-rounded-right-3" type="text" value="${board.boardName}">
		                  </div>
                        <br>
                        </th>
                        </tr>
                      ...
                      <tbody>
                        ...
                        <tr class="g-brd-bottom g-brd-gray-light-v3">
                          <td><textarea class="text-left g-py-70" name="board_content" style="border: none; outline: none;" cols="100%">${board.boardContent}</textarea></td> 
                        </tr>
                        <!-- End Item-->
                  ...
                  <div style="width:35%" class="input-group g-rounded-left-3 mb-3">
                    ...
                    <input name="password" class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v3 g-rounded-left-0 g-rounded-right-3 g-py-10 g-px-15" type="password" placeholder="비밀번호">
                  </div>
               ...
               <!-- Contact Form -->
		                ...
		                <div class="text-center">
		                  <input class="btn u-btn-primary g-font-size-12 text-uppercase g-py-12 g-px-25" type="submit" value="수정하기" style="font-weight: bold">&nbsp;&nbsp;&nbsp;&nbsp;<button class="btn g-color-gray-dark-v5 g-bg-secondary g-font-size-12 text-uppercase g-py-12 g-px-25" type="button" id="cancel"><b>취소하기</b></button>
		                </div>
