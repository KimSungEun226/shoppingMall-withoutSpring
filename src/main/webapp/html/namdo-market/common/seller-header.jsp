              ...
              <!-- Account -->
                  <li class="list-inline-item">
                    ...
                    <ul id="account-dropdown-2" class="list-unstyled u-shadow-v29 g-pos-abs g-bg-white g-width-160 g-pb-5 g-mt-19 g-z-index-2"
                      ...
                      <li>
                        <a class="d-block g-color-black g-color-primary--hover g-text-underline--none--hover g-font-weight-400 g-py-5 g-px-20" href="${pageContext.request.contextPath}/html/namdo-market/page-login-security-seller.jsp">
                          내정보
                        </a>
                      </li>
                      <li>
                        <a class="d-block g-color-black g-color-primary--hover g-text-underline--none--hover g-font-weight-400 g-py-5 g-px-20" href="${pageContext.request.contextPath}/front?key=item&methodName=selectBySellerNo&sellerNo=${sellerDTO.sellerNo}">
                          판매정보
                        </a>
                      </li>
                      <li>
              ...
              <div id="navBar" class="collapse navbar-collapse align-items-center flex-sm-row g-pt-15 g-pt-0--lg">
                <ul class="navbar-nav ml-auto">
                  ...
                  <li class="nav-item g-mx-10--lg g-mx-15--xl">
                    ...
                    <a class="nav-link text-uppercase g-color-primary--hover g-px-5 g-py-20" href="${pageContext.request.contextPath}/html/namdo-market/page-item-insert.jsp"><b>제품 등록</b></a>
                  </li>
                </ul>
              </div>
              <!-- End Navigation -->
