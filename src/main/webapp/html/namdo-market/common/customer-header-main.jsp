...
<body>
  <!-- Header -->
                ...
                <!-- 전체 카테고리 -->
                  ...
                  <li class="nav-item hs-has-sub-menu g-mx-10--lg g-mx-15--xl">
                    ...
                    <ul id="nav-submenu--home" class="hs-sub-menu list-unstyled u-shadow-v11 g-min-width-220 g-brd-top g-brd-primary g-brd-top-2 g-mt-7"
                      ...
                      <li class="dropdown-item">
                        <a class="nav-link g-color-gray-dark-v1" href="${pageContext.request.contextPath}/front?key=item&methodName=selectByInputItemName&input=홍어">장어</a>
                      </li>
                    </ul>
                    <!-- End Submenu -->
                  </li>
      ...
      <script type="text/javascript">
        document.getElementById("account-dropdown-invoker-2").innerHTML = "${sessionScope.customerDTO.customerName}님"
      </script>
