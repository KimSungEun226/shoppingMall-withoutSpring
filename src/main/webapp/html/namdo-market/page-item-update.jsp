...
<html lang="en">
  ...
  <body>
    <main>
      ...
      <!-- Help -->
      <form name="itemUpdate_form" method="post" action="${pageContext.request.contextPath}/front?key=item&methodName=update&itemNo=${itemDTO.itemNo}" enctype="multipart/form-data">
            ...
            <div id="nav-5-3-primary-ver" class="tab-content g-pt-20 g-pt-0--md">
                    ...
                    <table class="text-left w-100">
                      <thead class="h6 g-brd-bottom g-brd-gray-light-v3 g-color-black text-uppercase">
                        ...
                        <th>
		                  ...
		                  <div class="input-group mb-1">
		                    <b class="h5 g-color-black">상품명:&nbsp;&nbsp;&nbsp;</b><input id="itemName" name="itemName" class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v3 g-rounded-left-3 g-rounded-right-3 mr-3"  style="width:70%;" type="text" value="${itemDTO.itemName}">
		                  ...
		                  <b class="h5 g-color-black">카테고리:&nbsp;&nbsp;&nbsp;</b>
		                    <select id="categoryNo" name="categoryNo" class="js-custom-select u-select-v1 h-50 g-brd-gray-light-v3 g-color-gray-dark-v5 rounded mr-3" style="width:15%;">
		                      <option value="${itemDTO.categoryNo}">
		                      <c:choose>
		                      <c:when test="${itemDTO.categoryNo=='1'}">생선</c:when>
		                      <c:when test="${itemDTO.categoryNo=='2'}">건어물</c:when>
		                      <c:when test="${itemDTO.categoryNo=='3'}">김/해초</c:when>
		                      <c:when test="${itemDTO.categoryNo=='4'}">해산물/어패류</c:when>
		                      <c:when test="${itemDTO.categoryNo=='5'}">젓갈</c:when>
		                      <c:when test="${itemDTO.categoryNo=='6'}">수산물 기타</c:when>
		                    ...
		                    <select id="regionNo" name="regionNo" class="js-custom-select u-select-v1 h-50 g-brd-gray-light-v3 g-color-gray-dark-v5 rounded mr-3" style="width:15%;">
		                      <option value="${itemDTO.regionNo}">
		                      <c:choose>
		                      <c:when test="${itemDTO.regionNo=='1'}">영광</c:when>
		                      <c:when test="${itemDTO.regionNo=='2'}">목포</c:when>
		                      <c:when test="${itemDTO.regionNo=='3'}">무안</c:when>
		                      <c:when test="${itemDTO.regionNo=='4'}">보성</c:when>
		                      <c:when test="${itemDTO.regionNo=='6'}">신안</c:when>
		                      <c:when test="${itemDTO.regionNo=='7'}">여주</c:when>
		                      <c:when test="${itemDTO.regionNo=='8'}">완도</c:when>
		                      <c:when test="${itemDTO.regionNo=='9'}">해남</c:when>
		                      <c:when test="${itemDTO.regionNo=='11'}">진도</c:when>
		                      <c:when test="${itemDTO.regionNo=='14'}">고흥</c:when>
		                  ...
		                  <div class="input-group mb-1">
		                    <b class="h5 g-color-black">상품 가격:&nbsp;&nbsp;&nbsp;</b><input id="itemPrice" name="itemPrice" value="${itemDTO.itemPrice}" class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v3 g-rounded-left-3 g-rounded-right-3 mr-3 col-md-2 col-lg-2 col-sm-2"  style="width:70%;" type="text">
		                    <b class="h5 g-color-black">상품 재고량:&nbsp;&nbsp;&nbsp;</b><input id="itemStock" name="itemStock" value="${itemDTO.itemStock}" class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v3 g-rounded-left-3 g-rounded-right-3 mr-3 col-md-2 col-lg-2 col-sm-2" type="text">
                      ...
                      <tbody>
                        ...
                        <tr class="g-brd-bottom g-brd-gray-light-v3">
                          <td><textarea class="text-left g-py-70" id="itemDescription" name="itemDescription" style="border: none; outline: none;" cols="100%" >${itemDTO.itemDescription}</textarea></td> 
                        </tr>
                        <tr>
               ...
               <!-- Contact Form -->
		                ...
		                <div class="text-center">
		                  <button class="btn u-btn-primary g-font-size-12 text-uppercase g-py-12 g-px-25" type="button"  onclick="form_check()"><b>수정하기</b></button>&nbsp;&nbsp;&nbsp;&nbsp;<button class="btn g-color-gray-dark-v5 g-bg-secondary g-font-size-12 text-uppercase g-py-12 g-px-25" type="button" id="cancel"><b>취소하기</b></button>
		                </div>
