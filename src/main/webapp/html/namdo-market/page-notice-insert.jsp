...
<html lang="en">
  ...
  <body>
    <main>
      ...
      <!-- Help -->
      <form name="writeForm" method="post" action="${path}/front?key=board&methodName=addBoard" onSubmit="return checkValid()" enctype="multipart/form-data">
                    ...
                    <table class="text-left w-100">
                      <thead class="h6 g-brd-bottom g-brd-gray-light-v3 g-color-black text-uppercase">
                        ...
                        <th>
		                  ...
		                  <div class="input-group mb-1">
		                    <b class="h5 g-color-black">제목:&nbsp;&nbsp;&nbsp;</b><input name="board_name" class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v3 g-rounded-left-3 g-rounded-right-3" type="text">
		                  </div>
                        <br>
                        </th>
                        </tr>
                      ...
                      <tbody>
                        ...
                        <tr class="g-brd-bottom g-brd-gray-light-v3">
                          <td><textarea class="text-left g-py-70" name="board_content" style="border: none; outline: none;" cols="100%"></textarea></td> 
                        </tr>
                        <tr>
