                      ...
                      <tbody>
                          ...
                          <td class="text-left g-py-25">
                            ...
                            <div class="d-inline-block align-middle">
                              <h4 class="h6 g-color-black">
                                <a class="d-block g-color-text g-color-primary--hover g-text-underline--none--hover" href="page-category.jsp">Sneaker</a>
                              </h4>
                        ...
                        <tr class="g-brd-bottom g-brd-gray-light-v3">
                          ...
                          <td class="text-left g-py-25">
                            ...
                            <div class="d-inline-block align-middle">
                              <h4 class="h6 g-color-black">
                                <a class="d-block g-color-text g-color-primary--hover g-text-underline--none--hover" href="page-category.jsp">Chukka Shoes</a>
                              </h4>
                              <ul class="list-unstyled g-color-gray-dark-v4 g-font-size-12 g-line-height-1_6 mb-0">
                                <li>Color: Black</li>
                                <li>Size: MD</li>
                        ...
                        <tr class="g-brd-bottom g-brd-gray-light-v3">
                          ...
                          <td class="text-left g-py-25">
                            ...
                            <div class="d-inline-block align-middle">
                              <h4 class="h6 g-color-black">
                                <a class="d-block g-color-text g-color-primary--hover g-text-underline--none--hover" href="page-category.jsp">Desk Clock</a>
                              </h4>
                              <ul class="list-unstyled g-color-gray-dark-v4 g-font-size-12 g-line-height-1_6 mb-0">
                                <li>Color: Black</li>
                                <li>Size: MD</li>
