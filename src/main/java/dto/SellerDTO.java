...
public class SellerDTO {
	...
	public SellerDTO(int sellerNo, String sellerId, String sellerPwd, String sellerName, String sellerEmail,
			String sellerAddr, String sellerContact, String sellerRegDate, int sellerBusinessNo) {
		super();
